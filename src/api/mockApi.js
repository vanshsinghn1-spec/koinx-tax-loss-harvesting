const holdingsData = [
  {
    ...
    currentPrice: 85.41,
    totalHolding: 1000,
    averageBuyPrice: 90.0,
    stcg: { balance: 1000, gain: -4590.00 },
  ...
  },
  {
    ...
    stcg: { balance: 0.5, gain: -19122.00 },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    coin: "SOL",
...
/**
 * Simulate fetching holdings data from API
...
/**
 * Simulate fetching capital gains data from API
